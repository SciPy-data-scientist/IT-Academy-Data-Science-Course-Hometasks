...
distinct_colors = ['#e6194b', '#3cb44b', '#0082c8', '#ffe119']
...
def create_data_lists(bccd_path, output_folder):
    ...
    :param bccd_path: path to the 'BCCD' folder
...
def calculate_mAP(det_boxes, det_labels, det_scores, true_boxes, true_labels, true_difficulties):
    ...
    for c in range(1, n_classes):
        ...
        for d in range(n_class_detections):
            ...
            original_ind = torch.arange(true_class_boxes.size(0), device=true_class_images.device)[true_class_images == this_image][ind]
